...
describe("saved preference adapter", () => {
  ...
  it("resets only current global preferences and leaves uploaded documents untouched", () => {
    // This catches Reset acting like a destructive workspace wipe or retaining changed global values.
