...
describe("Image workbench layout and local-only guidance", () => {
  ...
  it("shows first-run Quick Start and persists only the tutorial marker when dismissed", () => {
    ...
    expect(dialog).toHaveTextContent("Build and Download are unavailable in this preview");
  ...
  it("explains review, invalidation, and the truthful Task 5 boundary in Help", () => {
    ...
    expect(help).toHaveTextContent("Changes invalidate image-set confirmation");
    expect(help).toHaveTextContent("BUILD PACKAGE and DOWNLOAD ZIP remain unavailable");
