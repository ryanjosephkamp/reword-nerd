...
import { buildFaithfulImagePrompt } from "./prompt";
...
function profile(definition: ProfileDefinition): Readonly<ImagePromptProfile> {
  ...
  return Object.freeze({
    ...
    promptBuilder: buildFaithfulImagePrompt,
...
export const IMAGE_PROMPT_PROFILES: readonly Readonly<ImagePromptProfile>[] = Object.freeze([
  ...
  profile({
    id: "ideogram",
    label: "Ideogram",
    referenceModel: "Ideogram 3 Remix",
    officialSourceUrls: ["https://docs.ideogram.ai/using-ideogram/features-and-tools/remix"],
    capabilityNotes: ["Use Remix as a guided variation workflow and verify visible text carefully."],
  }),
  profile({
    id: "midjourney",
    label: "Midjourney",
    referenceModel: "Current Midjourney Image Prompts",
